...
!(function (t, e) {
    ...
    function Oe(t, e, i) {
        ...
        e &&
            _e(t) &&
            ((s = (t.offsetWidth > 0 && Ee(n.width) / t.offsetWidth) || 1), (o = (t.offsetHeight > 0 && Ee(n.height) / t.offsetHeight) || 1));
    ...
    function ze(t) {
        ...
        if (c) {
            ...
            (A === me(i) && 'static' !== Le((A = De(i))).position && 'absolute' === a && ((E = 'scrollHeight'), (T = 'scrollWidth')),
                (s === qt || ((s === Qt || s === Kt) && o === Gt)) &&
                    ((y = Vt), (m -= (d && A === w && w.visualViewport ? w.visualViewport.height : A[E]) - n.height), (m *= l ? 1 : -1)),
                (s !== Qt && ((s !== qt && s !== Vt) || o !== Gt)) ||
                    ((v = Kt), (f -= (d && A === w && w.visualViewport ? w.visualViewport.width : A[T]) - n.width), (f *= l ? 1 : -1)));
        }
        var C,
        ...
        fn: function (t) {
            ...
            (null != e.modifiersData.popperOffsets &&
                (e.styles.popper = Object.assign(
                    {},
                    e.styles.popper,
                    ze(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l }))
                )),
                null != e.modifiersData.arrow &&
                    (e.styles.arrow = Object.assign(
                        {},
                        e.styles.arrow,
                        ze(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l }))
                    )),
                ...
                for (
                    var s = i.mainAxis,
                        ...
                        v = [g].concat(b).reduce(function (t, i) {
                            return t.concat(
                                ye(i) === Xt
                                    ? oi(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                                    : i
                            );
                        }, []),
                        y = e.rects.reference,
                ...
                h = {
                    ...
                    setOptions: function (i) {
                        ...
                        (d(),
                            ...
                            (a.scrollParents = { reference: ge(t) ? ti(t) : t.contextElement ? ti(t.contextElement) : [], popper: ti(e) }));
                        var r,
                            c,
                            u = (function (t) {
                                var e = pi(t);
    ...
    class Js extends W {
        constructor(t) {
            (super(t),
                ...
                this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), N.on(this._element, js, (t) => this._keydown(t))));
        }
        static get NAME() {
            return 'tab';
        }
