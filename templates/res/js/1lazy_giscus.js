(function () {
    ...
    var c = {
        ...
        strict: b.strict || 0,
        description: l('description', 1),
        backLink: l('giscus:backlink') || g,
        term: g,
    }
    ...
    if (d) {
        ...
        d.appendChild(e);
    } else (d = document.createElement('div')), d.setAttribute('class', 'giscus'), d.appendChild(e), m.insertAdjacentElement('afterend', d);
            ...
            ((a = a.data),
                ...
                (a.giscus.resizeHeight && (e.style.height = ''.concat(a.giscus.resizeHeight, 'px')),
                    a.giscus.signOut
                        ...
                        : a.giscus.error &&
                        ((a = a.giscus.error),
                            a.includes('Bad credentials') || a.includes('Invalid state value') || a.includes('State has expired')
                                ? null !== localStorage.getItem('giscus-session')
                                    ? (localStorage.removeItem('giscus-session'), console.warn(''.concat(h(a), ' Session has been cleared.')), p())
                                    : n ||
                                    console.error(
                                        ''
