...
/******/ var __webpack_modules__ = {
    ...
    /***/ 2222: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
        var $ = __webpack_require__(6518);
        var getBuiltIn = __webpack_require__(7751);
        var fails = __webpack_require__(9039);
...
class CommentManager {
    ...
    #menuAC = null;
    constructor(
        { dialog, toolbar, actions, menu, editMenuItem, deleteMenuItem, closeButton, textInput, textView, cancelButton, saveButton },
        overlayManager
    ) {
...
const PDFViewerApplication = {
    ...
    async _initializeViewerComponents() {
        ...
        const commentManager =
            AppOptions.get('enableComment') && appConfig.editCommentDialog ? new CommentManager(appConfig.editCommentDialog, overlayManager) : null;
