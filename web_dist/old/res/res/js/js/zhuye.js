...
function doSearch(){
    ...
    for(i=0 ; i<searchMember.length ; i++){if ( searchMember[i][0].test(InputValue)){search ( searchMember[i][1] , searchMember[i][2] );}}
    }else{ulStyle.display = "none";}
}
...
ulStyle.overflow = "scroll";
ulStyle.padding = "0";
ulStyle.backgroundColor = "#fff";